...
const BookingsCart = ({cart,handleDelete,HandleOreder}) => {
    const {serviceProvideremail,status,_id,name,area,price,photo,description}=cart;
    //console.log('the car is',cart)
    const axiosSecure=UseAxiosSecure()

    //console.log(serviceProvideremail)
    HandleOreder(serviceProvideremail);
